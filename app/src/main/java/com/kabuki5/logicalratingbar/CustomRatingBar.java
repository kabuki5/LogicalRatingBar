package com.kabuki5.logicalratingbar;
...
//    private Drawable mHalfImageResource;
    ...
    private void obtainData(AttributeSet attrs) {
        mFullImageResource = mContext.getResources().getDrawable(R.mipmap.ic_star_full);
        mEmptyImageResource = mContext.getResources().getDrawable(R.mipmap.ic_star_empty);
...
//                else if (fractional > 0.250 && fractional < 0.750) // TODO
//                    resource = half;
                else
                    resource = mFullImageResource;
                fractional = 0;
...
//                    animateImageViewChange(mContext, mImages.get(animCounter), animResource);
    ...
    public static void animateImageViewChange(Context c, final ImageView v, final Drawable new_image) {
        ...
        final Animation anim_in = AnimationUtils.loadAnimation(c, android.R.anim.fade_out);
